...
public enum ErrorString {
    ...
    ERROR_EMPTY_MARK_INT("     ☹ OOPS!!! Please specify a duke.task number for me to mark.\n"),
    ERROR_EMPTY_UNMARKED_INT("     ☹ OOPS!!! Please specify a duke.task number for me to unmark.\n"),
    ERROR_NOT_INT_MARK("     ☹ OOPS!!! The duke.task number you specify for me to mark\n     is invalid.\n"),
    ERROR_NOT_INT_UNMARKED("     ☹ OOPS!!! The duke.task number you specify for me to unmark\n     is invalid.\n"),
    ERROR_EMPTY_DELETE("     ☹ OOPS!!! Please specify a duke.task number for me to delete.\n"),
    ...
    ERROR_LOADING_ERROR("     ☹ OOPS!!! There is duke.error in loading the tasks from duke.txt\n"),
